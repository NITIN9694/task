class MenuData {
  ...
  MenuData({this.cat1, this.cat2, this.cat3, this.cat4, this.cat5, this.cat6});
...
class Cat1 {
  ...
  Cat1({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
...
class Cat2 {
  ...
  bool? instock ;
  int?itemQuantity;
  Cat2({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
...
class Cat3 {
  ...
  Cat3({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
...
class Cat4 {
  ...
  bool? instock ;
  int?itemQuantity;
  Cat4({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
...
class Cat5 {
  ...
  bool? instock ;
  int?itemQuantity;
  Cat5({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
...
class Cat6 {
  ...
  bool? instock ;
  int?itemQuantity;
  Cat6({this.name, this.price, this.instock,this.isAddItem  ,this.itemQuantity});
